...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>UJ HOTEL,</p>
				<p>Wonogiri,<br>Jawa Tengah,<br>Indonesia.</p>
				<p>(+62) 88212526550</p>
			</address>
			<span><img alt="" src="../images/uj.png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- danangkurniawan110@student.uns.ac.id || Web :- ultramanjowohotel.lovestoblog.com || Phone :- +62 88212526550 </p>
			</div>
		</aside>
	</body>
</html>
...
if(mysqli_query($koneksi,$rpsql))
{
	...
	if(mysqli_query($koneksi,$delsql))
	{
