                ...
                <div class="col-md-12">
										...
										while($row = mysqli_fetch_array($re))
										{
											...
											if($id % 2 ==0 )
											{
												echo"<tr class='gradeC'>
													...
													<td><a href=deleteuser.php?eid=".$id ." <button class='btn btn-danger'> <i class='fa fa-edit' ></i> Delete</button></td>
												</tr>";
											}
											else
											{
					...
					<div class="panel-body">
						...
						if(isset($_POST['in']))
						{
							...
							if(mysqli_query($koneksi,$newsql))
							{
